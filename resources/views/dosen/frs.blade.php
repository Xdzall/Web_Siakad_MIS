...
@section('content')
    ...
    <div class="space-y-4">
        @foreach([
            ['label' => 'MW', 'jumlah' => '25 / 60', 'nama' => 'Matematika Wajib', 'jadwal' => 'Senin 08.00 - 09.40'],
            ['label' => 'MPI', 'jumlah' => '22 / 30', 'nama' => 'Metode Penelitian Ilmiah', 'jadwal' => 'Selasa 10.00 - 11.40'],
            ['label' => 'MW', 'jumlah' => '30 / 30', 'nama' => 'Praktek Kecerdasan Buatan', 'jadwal' => 'Rabu 13.00 - 14.40']
        ] as $i => $frs)
            <div class="bg-white rounded-lg shadow p-4 flex justify-between items-center">
                <div>
                    <p class="text-sm font-medium text-gray-500">{{ $frs['label'] }}</p>
                    <p class="font-bold">{{ $frs['nama'] }}</p>
                    <p class="text-sm text-gray-500">{{ $frs['jadwal'] }}</p>
                </div>
